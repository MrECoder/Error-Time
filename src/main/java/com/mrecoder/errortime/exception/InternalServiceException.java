...
public class InternalServiceException extends AppException {
    ...
    public InternalServiceException(String message) {
        super(ErrorCode.INTERNAL_SERVICE_ERROR, message);
    }

    public InternalServiceException(String message, Throwable cause) {
        super(ErrorCode.INTERNAL_SERVICE_ERROR, message, Map.of(), cause);
    }

    public InternalServiceException(String message, Map<String, Object> details, Throwable cause) {
        super(ErrorCode.INTERNAL_SERVICE_ERROR, message, details, cause);
    }
}
