...
/**
 * Exercises {@link GlobalExceptionHandler} through real HTTP requests
 * (subtasks 2, 3) and asserts the traceId (subtask 4) and error-metric
 * (subtask 8) side effects it's responsible for.
 */
