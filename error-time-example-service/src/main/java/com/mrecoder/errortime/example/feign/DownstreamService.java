...
/**
 * Retries the downstream call only for failures the library's
 * {@code FeignErrorDecoder} classified as {@link InternalServiceException}
...
public class DownstreamService {
    ...
    public ResourceResponse recover(InternalServiceException ex, String id) {
        errorMetrics.recordDownstreamError(SOURCE, CommonErrorCode.RETRY_EXHAUSTED);
